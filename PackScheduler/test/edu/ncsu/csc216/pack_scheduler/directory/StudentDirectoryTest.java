...
//		} catch (IOException e) { fail("Unable to reset files"); }
	}
	...
	public void testLoadStudentsFromFile() {
		...
		Exception e = assertThrows(IllegalArgumentException.class, () -> sd.loadStudentsFromFile("test-files/a.txt"));
	...
	/**
	 * Tests StudentDirectory.addStudent() for invalid cases
	 */
	@Test
	public void testAddStudentInvalidOptions() {
		StudentDirectory sd = new StudentDirectory();
		sd.loadStudentsFromFile(validTestFile);
		
		Exception e = assertThrows(IllegalArgumentException.class, () -> sd.addStudent("Zahir", "King", "zking", "orci.Donec@ametmassaQuisque.com", "", "pw", 15));
		assertEquals("Invalid password", e.getMessage());
		Exception e2 = assertThrows(IllegalArgumentException.class, () -> sd.addStudent("Zahir", "King", "zking", "orci.Donec@ametmassaQuisque.com", "pw", "", 15));
		assertEquals("Invalid password", e2.getMessage());
		Exception f = assertThrows(IllegalArgumentException.class, () -> sd.addStudent("Zahir", "King", "zking", "orci.Donec@ametmassaQuisque.com", "pz", "pw", 15));
		assertEquals("Passwords do not match", f.getMessage());
		Exception g = assertThrows(IllegalArgumentException.class, () -> sd.addStudent("Zahir", "King", "zking", "orci.Donec@ametmassaQuisque.com", "pw", "pw", 2));
		assertEquals("Invalid max credits", g.getMessage());
		Exception g2 = assertThrows(IllegalArgumentException.class, () -> sd.addStudent("Zahir", "King", "zking", "orci.Donec@ametmassaQuisque.com", "pw", "pw", 19));
		assertEquals("Invalid max credits", g2.getMessage());
		Exception h = assertThrows(IllegalArgumentException.class, () -> sd.addStudent("Zahir", "King", "zking", "orci.Donec@ametmassaQuisque.com", null, "pw", 15));
		assertEquals("Invalid password", h.getMessage());
		Exception h2 = assertThrows(IllegalArgumentException.class, () -> sd.addStudent("Zahir", "King", "zking", "orci.Donec@ametmassaQuisque.com", "pw", null, 15));
		assertEquals("Invalid password", h2.getMessage());
		assertFalse(sd.addStudent("Zack", "King", "zking", "orci.Donec@ametmassaQuisque.com", "pw", "pw", 15));
	...
	/**
	 * Tests getStudentById method. Expects null output if student is not found.
	 */
	@Test
	public void testGetStudentById() {
		...
		assertEquals(null, sd.getStudentById("nonexistent"));
		
		StudentDirectory sd2 = new StudentDirectory();
		
		assertEquals(null, sd2.getStudentById("zking"));
	}
	...
	public void testSaveStudentDirectory() {
		...
		Exception e = assertThrows(IllegalArgumentException.class, () -> sd.saveStudentDirectory("/home.sesmith5/actual_student_records.txt"));
