...
public class FacultyDirectory {
	 ...
	 * @throws IllegalArgumentException if the file cannot be found / read
	 */
	 ...
	 * @param maxCourses faculty max credits.
	 * @return true if added
	 * @throws IllegalArgumentException if password is invaid, pwds do not match, or invalid max credits
	 */
	public boolean addFaculty(String firstName, String lastName, String id, String email, String password, String repeatPassword, int maxCourses) {
		...
		if (maxCourses < Faculty.MIN_COURSES
				|| maxCourses > Faculty.MAX_COURSES) {
	...
	/**
	 * Returns a Faculty with the id provided. Returns null if no Faculty have that id.
	 * @param id the Faculty id who should be returned
	 * @return the Faculty
	 */
